...
/**
 * The point of interest controller deals with any functions to do with PIs. It extends the AbstractController to handle checking of Dt information is correct
 */
public class PIController {
	...
	/**
	 * Returns a list of all points of interest in the system, without using a logged in user.
	 *
	 ...
	 */
	public ArrayList<CtPI> getListOfPIs() throws ServerOfflineException, ServerNotBoundException{
		try {
